        ...
        for end in range(length-1, -1, -1):
            for start in range(length-1, -1, -1):
                for mid in range(start, end+1):
                    ...
                    if word in dict:
                        if mid == end:
                            arr[start][end].append(word)
                        else:
                            for old in arr[mid+1][end]:
                                arr[start][end].append(word + " " + old)
